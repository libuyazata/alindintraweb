...
// import { stat } from 'fs';
@Component({
  selector: 'general-message-sent',
  templateUrl: './general-message-sent.component.html',
  styleUrls: ['./general-message-sent.component.scss']
})
export class GeneralmessagesentComponent extends BaseComponent implements OnInit {
  ...
  protected getWorkDetailsList() {
	...
	this.GeneralmessagesentService.getWorkDetailsList(params).subscribe((resp:any)=>{      
  ...
  protected getdepartmentListByWorkId(workDetailsId:number){
	...
	this.GeneralmessagesentService.getdepartmentListByWorkId(workId).subscribe((resp:any) => {
  ...
  protected getsubtaskListByWorkId(workDetailsId:number){
	...
	this.GeneralmessagesentService.getsubtaskListByWorkId(params).subscribe((resp:any) => {
  ...
  protected getworkDescription(workDetailsId:number){
	...
	this.GeneralmessagesentService.getworkDescription(params).subscribe((resp:any) => {
 ...
 */ 
 private getPreparedReplyParams(submitDataReply: any) {
  ...
  public downloadAttachment(deptCommId:any) {
	this.GeneralmessagesentService.downloadWorkMessageAttachmentByOffComId(deptCommId).subscribe((resp:any)=>{      
